...
val miraiEvents by lazy {
    ...
    map.apply {
        ...
        set("TempMessageEvent", GroupTempMessageEvent::class)  //机器人收到的临时会话群消息的事件
        set("GroupTempMessageEvent", GroupTempMessageEvent::class)  //机器人收到的临时会话群消息的事件
    }
}

@MiraiExperimentalApi
@MiraiInternalApi
val miraiEventNames by lazy {
    miraiEvents.entries.associate { (k, v) -> v to k }
}
